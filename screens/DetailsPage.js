...
export default function LandingPage({navigation}){
    ...
    return(
        <ScrollView style={styles.container}>
            <ImageBackground style={styles.bgImage} source='https://purepng.com/public/uploads/large/purepng.com-sofasofafurniturearmrestsentirely-upholsteredloungecouchbedsteaddivan-1701527997536r8xka.png'></ImageBackground>
            <ScrollView horizontal={true} style={styles.imageTypes}>
                <Image style={styles.image} source='https://images-na.ssl-images-amazon.com/images/I/71vkir3wegL.jpg'></Image>
                <Image style={styles.image} source='https://images-na.ssl-images-amazon.com/images/I/71vkir3wegL.jpg'></Image>
                <Image style={styles.image} source='https://images-na.ssl-images-amazon.com/images/I/71vkir3wegL.jpg'></Image>
                <Image style={styles.image} source='https://images-na.ssl-images-amazon.com/images/I/71vkir3wegL.jpg'></Image>
                <Image style={styles.image} source='https://images-na.ssl-images-amazon.com/images/I/71vkir3wegL.jpg'></Image>
            ...
            <Text style={{color:'blue', fontSize:20, paddingLeft:10, paddingRight:10, paddingTop:10}}>Lorem ipsum dolor sit.</Text>
